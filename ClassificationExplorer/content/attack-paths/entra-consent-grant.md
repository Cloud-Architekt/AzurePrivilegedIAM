...
source: Microsoft Security | https://learn.microsoft.com/entra/identity/enterprise-apps/protect-against-consent-phishing
severity: Critical
...
## Prerequisite
A role that can manage app role assignments or OAuth2 permission grants.

## Steps
1. Create or take control of a service principal in the tenant.
2. Grant the service principal a high-impact Microsoft Graph app role (for example RoleManagement.ReadWrite.Directory).
